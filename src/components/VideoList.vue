...
<template>
    <div class="section section--video dark:text-white">
        <div class="container">
            ...
            <div class="section--video__swiper swiper">
                <div class="swiper-wrapper *:*:dark:hover:shadow-white/20">
                ...
                <div class="swiper-button swiper-button-prev">
                    <span class="swiper-button-icon bg-white text-primary">
                ...
                <div class="swiper-button swiper-button-next bg-gradient-to-r from-transparent to-50% to-white dark:to-zinc-900">
                    <span class="swiper-button-icon bg-white text-primary">
                        <svg  width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<style>
    @import '../assets/sass/components/videos-swipe.css';
</style>