        ...
        <div class="absolute bottom-0 pb-20 left-0 w-full bg-gradient-to-t gap-4 px-4 from-black/30 flex lg:items-stretch lg:flex-col from-90% to-transparent items-end pt-8 pointer-events-none lg:pb-8 lg:static lg:bg-none">
            <div class="description">
                <svg class="shrink-0 h-4 w-auto mb-4 lg:text-orange-600" width="42" height="12" viewBox="0 0 42 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.09511 1.71429H5.71394V0H0V12H5.71394V10.2857H2.09511V6.77143H4.97113V5.05714H2.09511V1.71429Z" fill="currentColor"/>
                    <path d="M12.0595 12H14.2118V0H12.3452V7.18286L10.193 0H7.56458V12H9.45018V3.30857L12.0595 12Z" fill="currentColor"/>
                    <path d="M20.9306 0H17.8641L15.7309 12H17.6546L18.0165 9.82286H20.5878L20.9496 12H23.0638L20.9306 0ZM19.2926 2.12571L20.3021 8.19429H18.2831L19.2926 2.12571Z" fill="currentColor"/>
            ...
            <div class="button flex flex-col justify-between gap-2 lg:bg-neutral-200 lg:rounded-xl lg:p-2 lg:flex-row  pointer-events-auto lg:dark:bg-white/20">
                <label class="flex flex-col items-center justify-center text-xs lg:flex-row cursor-pointer">
                    <!-- Checkbox dengan peer -->
                    <input type="checkbox" class="peer hidden" />
                    
                    <!-- Icon -->
                    <div class="size-10 rounded-full flex items-center justify-center  hover:bg-neutral-800 lg:hover:bg-transparent  peer-checked:bg-white peer-checked:text-black lg:peer-checked:bg-transparent lg:peer-checked:text-green-500">
                        <svg class="shrink-0 size-5" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13.1094 0.631913C13.7961 0.64045 14.4723 0.804014 15.0869 1.11043C15.7015 1.41687 16.2391 1.85818 16.6592 2.40144C17.0792 2.94474 17.3708 3.5762 17.5127 4.24812C17.6542 4.91849 17.642 5.61211 17.4785 6.27742L17.4795 6.2784L16.6416 9.72664H21.998C22.5062 9.72664 23.0074 9.84509 23.4619 10.0723C23.9165 10.2996 24.3123 10.6296 24.6172 11.0362C24.9219 11.4426 25.1278 11.9144 25.2188 12.4141C25.3097 12.9142 25.2829 13.4292 25.1406 13.9171L22.4922 23.0108V23.0118C22.2938 23.6916 21.88 24.289 21.3135 24.7139C20.7469 25.1388 20.0578 25.3682 19.3496 25.3682H4.00195C3.1338 25.3682 2.30138 25.0231 1.6875 24.4093C1.07363 23.7953 0.728526 22.963 0.728516 22.0948V13.0001C0.728539 12.1319 1.07363 11.2995 1.6875 10.6856C2.30138 10.0717 3.1338 9.7267 4.00195 9.72664H7.13965L7.31543 9.71394C7.49017 9.68944 7.65851 9.62888 7.80957 9.53523C8.01095 9.41036 8.17385 9.23181 8.2793 9.01961L8.28027 9.01668L12.2021 1.18465C12.3736 0.842157 12.7264 0.62717 13.1094 0.631913ZM10.0693 9.91219L10.0684 9.91121C9.79733 10.4557 9.38116 10.9149 8.86426 11.2354C8.71985 11.325 8.56837 11.4012 8.41309 11.4669V23.3682H19.3496C19.6251 23.3682 19.8929 23.2786 20.1133 23.1134C20.3337 22.948 20.4951 22.7158 20.5723 22.4512L23.2207 13.3575V13.3565C23.276 13.1668 23.2863 12.967 23.251 12.7725C23.2156 12.578 23.1352 12.3946 23.0166 12.2364C22.898 12.0782 22.7442 11.9498 22.5674 11.8614C22.3906 11.773 22.1957 11.7266 21.998 11.7266H15.3701C15.0635 11.7265 14.7735 11.5858 14.584 11.3448C14.3944 11.1037 14.3261 10.7884 14.3984 10.4903L15.5352 5.80672L15.5361 5.80281C15.6285 5.42865 15.6353 5.03829 15.5557 4.66121C15.476 4.28415 15.3119 3.92995 15.0762 3.62508C14.8404 3.32026 14.5392 3.07242 14.1943 2.90047C14.0285 2.81778 13.8544 2.75392 13.6758 2.70906L10.0693 9.91219ZM2.72852 22.0948C2.72853 22.4325 2.86277 22.7564 3.10156 22.9952C3.34037 23.234 3.66424 23.3682 4.00195 23.3682H6.41309V11.7266H4.00195C3.66424 11.7267 3.34037 11.8609 3.10156 12.0997C2.86277 12.3385 2.72854 12.6623 2.72852 13.0001V22.0948Z"
                            fill="currentColor" />
                        </svg>
                    </div>
                    
                    <!-- Counter -->
                    <span class="lg:peer-checked:text-green-500">172</span>
                </label>
                            ...
                            <div class="share__social   flex items-center justify-center gap-5 mb-5">
                                <a href="#" target="_blank" class="share__social__button share__social__button--facebook   flex transition-transform duration-300 ease-in-out hover:scale-125 *:pointer-events-none">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M7.665 17.9166H10.9983V11.2416H14.0017L14.3317 7.92498H10.9983V6.24998C10.9983 6.02897 11.0861 5.817 11.2424 5.66072C11.3987 5.50444 11.6107 5.41665 11.8317 5.41665H14.3317V2.08331H11.8317C10.7266 2.08331 9.66679 2.5223 8.88539 3.3037C8.10399 4.0851 7.665 5.14491 7.665 6.24998V7.92498H5.99833L5.66833 11.2416H7.665V17.9166Z" fill="currentColor"></path>
                                    </svg>
                                </a>
                                <a href="#" target="_blank" class="share__social__button share__social__button--whatsapp   flex transition-transform duration-300 ease-in-out hover:scale-125 *:pointer-events-none">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M9.99996 1.66669C5.39746 1.66669 1.66663 5.39752 1.66663 10C1.66663 11.575 2.10413 13.05 2.86496 14.3067L2.12163 16.8334C2.07895 16.9784 2.07614 17.1323 2.1135 17.2788C2.15085 17.4254 2.227 17.5591 2.33393 17.6661C2.44085 17.773 2.57461 17.8491 2.72114 17.8865C2.86767 17.9238 3.02156 17.921 3.16663 17.8784L5.69329 17.135C6.99224 17.9208 8.48183 18.3353 9.99996 18.3334C14.6025 18.3334 18.3333 14.6025 18.3333 10C18.3333 5.39752 14.6025 1.66669 9.99996 1.66669ZM8.11496 11.8859C9.80079 13.5709 11.41 13.7934 11.9783 13.8142C12.8425 13.8459 13.6841 13.1859 14.0116 12.42C14.0526 12.3247 14.0674 12.2201 14.0545 12.1171C14.0417 12.0142 14.0015 11.9165 13.9383 11.8342C13.4816 11.2509 12.8641 10.8317 12.2608 10.415C12.1349 10.3277 11.98 10.2927 11.8288 10.3172C11.6776 10.3418 11.5418 10.424 11.45 10.5467L10.95 11.3092C10.9235 11.35 10.8826 11.3793 10.8354 11.391C10.7882 11.4028 10.7383 11.3962 10.6958 11.3725C10.3566 11.1784 9.86246 10.8484 9.50746 10.4934C9.15246 10.1384 8.84246 9.66669 8.66829 9.34919C8.64722 9.30873 8.64127 9.26209 8.6515 9.21764C8.66174 9.1732 8.68749 9.13385 8.72413 9.10669L9.49413 8.53502C9.60433 8.43968 9.67548 8.30703 9.69393 8.16248C9.71239 8.01793 9.67685 7.87165 9.59413 7.75169C9.22079 7.20502 8.78579 6.51002 8.15496 6.04919C8.07337 5.99057 7.97803 5.95401 7.87817 5.94306C7.77831 5.93211 7.67731 5.94714 7.58496 5.98669C6.81829 6.31502 6.15496 7.15669 6.18663 8.02252C6.20746 8.59085 6.42996 10.2 8.11496 11.8859Z" fill="currentColor"></path>
                                    </svg>
                                </a>
                                <a href="#" target="_blank" class="share__social__button share__social__button--x   flex transition-transform duration-300 ease-in-out hover:scale-125 *:pointer-events-none">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M8.74004 12.2092L12.7084 17.5H18.5417L11.9934 8.76833L17.4417 2.5H15.2334L10.9692 7.405L7.29171 2.5H1.45837L7.71671 10.8458L1.93337 17.5H4.14171L8.74004 12.2092ZM13.5417 15.8333L4.79171 4.16667H6.45837L15.2084 15.8333H13.5417Z" fill="currentColor"></path>
                                    </svg>
                                </a>
                                <a href="#" target="_blank" class="share__social__button share__social__button--telegram   flex transition-transform duration-300 ease-in-out hover:scale-125 *:pointer-events-none">
                                    <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10.5696 1.00093C11.7577 1.01024 12.9323 1.25474 14.0255 1.72032C15.1187 2.18589 16.1088 2.86333 16.9389 3.71354C17.7699 4.56405 18.4241 5.5708 18.8637 6.67563C19.3034 7.78045 19.5197 8.96144 19.5003 10.1504C18.8901 22.0232 1.89982 21.9224 1.50022 10.0109C1.49191 8.8197 1.72134 7.63884 2.17506 6.53743C2.62879 5.43603 3.2977 4.43622 4.14263 3.59654C4.98707 2.75771 5.99057 2.09602 7.09421 1.6503C8.19786 1.20457 9.37943 0.983796 10.5696 1.00093ZM12.2058 8.53936C12.2058 8.53936 12.2202 8.54836 12.1095 8.68876C11.9738 8.85257 11.8268 9.00656 11.6694 9.14956L9.37975 11.3726C8.89015 11.8622 8.90005 12.1628 9.46975 12.5732C10.1997 13.0934 10.9395 13.574 11.6901 14.0852C12.4398 14.5955 13.3596 15.3452 13.7403 14.2445C13.8369 13.9505 13.9101 13.6505 13.9599 13.3445C14.1201 12.4625 14.2803 11.5823 14.4198 10.6913C14.6097 9.44026 14.7897 8.18926 14.9499 6.92745C15.03 6.30645 14.6997 6.02655 14.0796 6.17685C13.8238 6.23699 13.5732 6.31703 13.3299 6.41625L6.79944 9.17026C6.18024 9.42947 5.56014 9.71027 4.94993 10.0109C4.79963 10.0901 4.60973 10.3106 4.61963 10.4609C4.62953 10.6112 4.84013 10.7813 5.01023 10.8515C5.42964 11.0216 5.87964 11.1413 6.31974 11.2817C6.65444 11.396 7.01223 11.4257 7.36119 11.368C7.71014 11.3104 8.03939 11.1672 8.31955 10.9514C9.15024 10.3592 9.99375 9.78512 10.8495 9.22966C11.25 8.95966 11.5299 8.80936 11.9205 8.53846C12.1203 8.43946 12.1653 8.39266 12.2058 8.45296V8.53936Z" fill="currentColor"></path>
                                    </svg>
                                </a>
                                <a href="#" target="_blank" class="share__social__button share__social__button--linkedin   flex transition-transform duration-300 ease-in-out hover:scale-125 *:pointer-events-none">
                                    <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6.05511 3.77844C6.05487 4.24988 5.86737 4.70191 5.53385 5.0351C5.20032 5.36829 4.7481 5.55535 4.27667 5.55511C3.80523 5.55487 3.35319 5.36737 3.02001 5.03385C2.68682 4.70032 2.49976 4.2481 2.5 3.77667C2.50024 3.30523 2.68774 2.85319 3.02126 2.52001C3.35479 2.18682 3.80701 1.99976 4.27844 2C4.74988 2.00024 5.20191 2.18774 5.5351 2.52126C5.86829 2.85479 6.05535 3.30701 6.05511 3.77844ZM6.10844 6.87139H2.55333V17.9989H6.10844V6.87139ZM11.7255 6.87139H8.18817V17.9989H11.69V12.1596C11.69 8.90669 15.9294 8.60451 15.9294 12.1596V17.9989H19.4401V10.9509C19.4401 5.46712 13.1653 5.67154 11.69 8.36453L11.7255 6.87139Z" fill="currentColor"></path>
                                    </svg>
                                </a>
                            </div>
                            <a href="#" target="_blank" class="share__copy text-primary border-primary hover:bg-primary hover:text-white   flex items-center justify-center gap-1 py-1 border rounded-md transition-all duration-300 ease-in-out *:pointer-events-none">
                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.50004 8.50002C9.50004 10.62 7.78671 12.3334 5.66671 12.3334C3.54671 12.3334 1.83337 10.62 1.83337 8.50002C1.83337 6.38002 3.54671 4.66669 5.66671 4.66669" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M7.16663 8.5C7.16663 6.29333 8.95996 4.5 11.1666 4.5C13.3733 4.5 15.1666 6.29333 15.1666 8.5C15.1666 10.7067 13.3733 12.5 11.1666 12.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                </svg>
                                <span>Copy Link</span>
                            </a>
                        </div>
