<script setup>
    import LogoKly from '../assets/image/logo-kly.png';
                ...
                <div class="section--trending__box__row">
                    ...
                    <div class="section--trending__box__row__swiper">
                        ...
                        <div class="swiper-button swiper-button-prev">
                            <span class="swiper-button-icon text-white" :class="swiperBtn">
                        ...
                        <div class="swiper-button swiper-button-next bg-gradient-to-r from-transaprent to-50%" :class="fade">
                            <span class="swiper-button-icon text-white" :class="swiperBtn">
                                <svg  width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<style>
    @import '../assets/sass/components/trending.css';
</style>